...
type User struct {
	...
	SubscriptionStatus  string    `gorm:"size:16;default:pending;index:idx_users_sub_status_expire,priority:1" json:"subscription_status"` // pending/active/expired/disabled
	...
	ExpireTime          int64     `gorm:"default:0;index:idx_users_sub_status_expire,priority:2" json:"expire_time"`

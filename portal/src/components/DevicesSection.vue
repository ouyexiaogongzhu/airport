<template>
  <section class="devices-section" id="devices">
    ...
    <div v-if="pending" class="modal-overlay" role="dialog" aria-modal="true" @click.self="pending = null">
      <div class="modal">
        <h4>Revoke device?</h4>
        <p>
        ...
        <div class="modal-actions">
          <button class="btn-outline" type="button" @click="pending = null">Cancel</button>
          <button class="btn-danger" type="button" @click="doRevoke">Revoke</button>
        </div>
      </div>
    </div>
  </section>
...
.section-header h3 { margin: 0; font-size: 1rem; color: #f0f0f0; }
